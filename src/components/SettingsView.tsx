    ...
    <section>
      <div className="page-heading">
        <div>
          ...
          <p>Core analysis and planning stay on this Windows PC.</p>
        </div>
      </div>
      ...
      <div className="panel roadmap-card">
        <p className="eyebrow">Prepared integrations</p>
        <h2>Export roadmap</h2>
        <div className="integration-grid"><span>rekordbox XML</span><span>VirtualDJ database.xml</span><span>Serato crates & cues</span><span>Optional encrypted cloud sync</span></div>
      </div>
    </section>
  );
}
